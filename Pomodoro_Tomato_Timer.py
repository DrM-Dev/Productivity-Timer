...
print(f"******** WELCOME TO Pomodoro Tomato Timer {ver}    -   By: Dr.m DEV *********")
...
#----
#adding image:
tomato_image = PhotoImage(file=r"images/tomato.png")
...
#
logo_image = PhotoImage(file=r"images/logo_ico.png")
